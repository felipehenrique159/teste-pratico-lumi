...
export default class InvoiceRepository {
    static async create(idCustomer: number, extractedData: PdfExtractData) {
        await Invoice.create({
            ...
            electric_energy_quant: extractedData.electricEnergy ? extractedData.electricEnergy.quant : null,
            electric_energy_united_value: extractedData.electricEnergy ? extractedData.electricEnergy.unitedValue : null,
            electric_energy_value: extractedData.electricEnergy ? extractedData.electricEnergy.value : null,
